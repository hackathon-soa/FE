...
import com.example.soa.databinding.FragmentSignUpFinishBinding
...
class SignUpFinishFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnLogin.setOnClickListener {
            findNavController().navigate(R.id.action_signupFinishFragment_to_loginFragment)
        }
    ...
    companion object {
         ...
         * @return A new instance of fragment SignUpFinishFragment.
         */
